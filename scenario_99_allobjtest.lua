...
-- Artifacts
artifact_1 = Artifact():setModel("artifact1"):setCallSign("artifact1"):setPosition(10000,  -7500)
artifact_2 = Artifact():setModel("artifact2"):setCallSign("artifact2"):setPosition(12500, -10000)
artifact_3 = Artifact():setModel("artifact3"):setCallSign("artifact3"):setPosition(15000, -12500)
artifact_4 = Artifact():setModel("artifact4"):setCallSign("artifact4"):setPosition(17500, -15000)
artifact_5 = Artifact():setModel("artifact5"):setCallSign("artifact5"):setPosition(20000, -17500)
artifact_6 = Artifact():setModel("artifact6"):setCallSign("artifact6"):setPosition(22500, -20000)
artifact_7 = Artifact():setModel("artifact7"):setCallSign("artifact7"):setPosition(25000, -22500)
artifact_8 = Artifact():setModel("artifact8"):setCallSign("artifact8"):setPosition(27500, -25000)
...
-- Unused models
adlerlongrangescoutgreen_1 = Artifact():setModel("AdlerLongRangeScoutGreen"):setCallSign("AdlerLongRangeScoutGreen"):setPosition(-2500, -2500)
adlerlongrangescoutgrey_1 = Artifact():setModel("AdlerLongRangeScoutGrey"):setCallSign("AdlerLongRangeScoutGrey"):setPosition(-5000, -5000)
adlerlongrangescoutwhite_1 = Artifact():setModel("AdlerLongRangeScoutWhite"):setCallSign("AdlerLongRangeScoutWhite"):setPosition(-7500, -7500)
atlasheavyfighterblue_1 = Artifact():setModel("AtlasHeavyFighterBlue"):setCallSign("AtlasHeavyFighterBlue"):setPosition(-10000, -10000)
atlasheavyfightergreen_1 = Artifact():setModel("AtlasHeavyFighterGreen"):setCallSign("AtlasHeavyFighterGreen"):setPosition(-12500, -12500)
atlasheavyfightergrey_1 = Artifact():setModel("AtlasHeavyFighterGrey"):setCallSign("AtlasHeavyFighterGrey"):setPosition(-15000, -15000)
atlasheavyfighterwhite_1 = Artifact():setModel("AtlasHeavyFighterWhite"):setCallSign("AtlasHeavyFighterWhite"):setPosition(-17500, -17500)
heavycorvetteblue_1 = Artifact():setModel("HeavyCorvetteBlue"):setCallSign("HeavyCorvetteBlue"):setPosition(-20000, -20000)
heavycorvettegreen_1 = Artifact():setModel("HeavyCorvetteGreen"):setCallSign("HeavyCorvetteGreen"):setPosition(-22500, -22500)
heavycorvettegrey_1 = Artifact():setModel("HeavyCorvetteGrey"):setCallSign("HeavyCorvetteGrey"):setPosition(-25000, -25000)
heavycorvettewhite_1 = Artifact():setModel("HeavyCorvetteWhite"):setCallSign("HeavyCorvetteWhite"):setPosition(-27500, -27500)
heavycorvetteyellow_1 = Artifact():setModel("HeavyCorvetteYellow"):setCallSign("HeavyCorvetteYellow"):setPosition(-30000, -30000)
lasercorvetteblue_1 = Artifact():setModel("LaserCorvetteBlue"):setCallSign("LaserCorvetteBlue"):setPosition(-32500, -32500)
lasercorvettegreen_1 = Artifact():setModel("LaserCorvetteGreen"):setCallSign("LaserCorvetteGreen"):setPosition(-35000, -35000)
lasercorvettegrey_1 = Artifact():setModel("LaserCorvetteGrey"):setCallSign("LaserCorvetteGrey"):setPosition(-37500, -37500)
lasercorvettered_1 = Artifact():setModel("LaserCorvetteRed"):setCallSign("LaserCorvetteRed"):setPosition(-40000, -40000)

lasercorvettewhite_1 = Artifact():setModel("LaserCorvetteWhite"):setCallSign("LaserCorvetteWhite"):setPosition(-2500, 0)
lasercorvetteyellow_1 = Artifact():setModel("LaserCorvetteYellow"):setCallSign("LaserCorvetteYellow"):setPosition(-5000, -2500)
lightcorvetteblue_1 = Artifact():setModel("LightCorvetteBlue"):setCallSign("LightCorvetteBlue"):setPosition(-7500, -5000)
lightcorvettegreen_1 = Artifact():setModel("LightCorvetteGreen"):setCallSign("LightCorvetteGreen"):setPosition(-10000, -7500)
lightcorvettered_1 = Artifact():setModel("LightCorvetteRed"):setCallSign("LightCorvetteRed"):setPosition(-12500, -10000)
lightcorvettewhite_1 = Artifact():setModel("LightCorvetteWhite"):setCallSign("LightCorvetteWhite"):setPosition(-15000, -12500)
lightcorvetteyellow_1 = Artifact():setModel("LightCorvetteYellow"):setCallSign("LightCorvetteYellow"):setPosition(-17500, -15000)
lindwurmfighterblue_1 = Artifact():setModel("LindwurmFighterBlue"):setCallSign("LindwurmFighterBlue"):setPosition(-20000, -17500)
lindwurmfightergreen_1 = Artifact():setModel("LindwurmFighterGreen"):setCallSign("LindwurmFighterGreen"):setPosition(-22500, -20000)
lindwurmfightergrey_1 = Artifact():setModel("LindwurmFighterGrey"):setCallSign("LindwurmFighterGrey"):setPosition(-25000, -22500)
lindwurmfighterred_1 = Artifact():setModel("LindwurmFighterRed"):setCallSign("LindwurmFighterRed"):setPosition(-27500, -25000)
lindwurmfighterwhite_1 = Artifact():setModel("LindwurmFighterWhite"):setCallSign("LindwurmFighterWhite"):setPosition(-30000, -27500)
minelayercorvetteblue_1 = Artifact():setModel("MineLayerCorvetteBlue"):setCallSign("MineLayerCorvetteBlue"):setPosition(-32500, -30000)
minelayercorvettegreen_1 = Artifact():setModel("MineLayerCorvetteGreen"):setCallSign("MineLayerCorvetteGreen"):setPosition(-35000, -32500)
minelayercorvettegrey_1 = Artifact():setModel("MineLayerCorvetteGrey"):setCallSign("MineLayerCorvetteGrey"):setPosition(-37500, -35000)
minelayercorvettered_1 = Artifact():setModel("MineLayerCorvetteRed"):setCallSign("MineLayerCorvetteRed"):setPosition(-40000, -37500)
minelayercorvettewhite_1 = Artifact():setModel("MineLayerCorvetteWhite"):setCallSign("MineLayerCorvetteWhite"):setPosition(-42500, -40000)

minelayercorvetteyellow_1 = Artifact():setModel("MineLayerCorvetteYellow"):setCallSign("MineLayerCorvetteYellow"):setPosition(-5000, 0)
missilecorvetteblue_1 = Artifact():setModel("MissileCorvetteBlue"):setCallSign("MissileCorvetteBlue"):setPosition(-7500, -2500)
missilecorvettegrey_1 = Artifact():setModel("MissileCorvetteGrey"):setCallSign("MissileCorvetteGrey"):setPosition(-10000, -5000)
missilecorvettered_1 = Artifact():setModel("MissileCorvetteRed"):setCallSign("MissileCorvetteRed"):setPosition(-12500, -7500)
missilecorvettewhite_1 = Artifact():setModel("MissileCorvetteWhite"):setCallSign("MissileCorvetteWhite"):setPosition(-15000, -10000)
missilecorvetteyellow_1 = Artifact():setModel("MissileCorvetteYellow"):setCallSign("MissileCorvetteYellow"):setPosition(-17500, -12500)
multiguncorvetteblue_1 = Artifact():setModel("MultiGunCorvetteBlue"):setCallSign("MultiGunCorvetteBlue"):setPosition(-20000, -15000)
multiguncorvettegreen_1 = Artifact():setModel("MultiGunCorvetteGreen"):setCallSign("MultiGunCorvetteGreen"):setPosition(-22500, -17500)
multiguncorvettegrey_1 = Artifact():setModel("MultiGunCorvetteGrey"):setCallSign("MultiGunCorvetteGrey"):setPosition(-25000, -20000)
multiguncorvettered_1 = Artifact():setModel("MultiGunCorvetteRed"):setCallSign("MultiGunCorvetteRed"):setPosition(-27500, -22500)
multiguncorvettewhite_1 = Artifact():setModel("MultiGunCorvetteWhite"):setCallSign("MultiGunCorvetteWhite"):setPosition(-30000, -25000)
multiguncorvetteyellow_1 = Artifact():setModel("MultiGunCorvetteYellow"):setCallSign("MultiGunCorvetteYellow"):setPosition(-32500, -27500)
sensorbuoymki_1 = Artifact():setModel("SensorBuoyMKI"):setCallSign("SensorBuoyMKI"):setPosition(-35000, -30000)
sensorbuoymkii_1 = Artifact():setModel("SensorBuoyMKII"):setCallSign("SensorBuoyMKII"):setPosition(-37500, -32500)
sensorbuoymkiii_1 = Artifact():setModel("SensorBuoyMKIII"):setCallSign("SensorBuoyMKIII"):setPosition(-40000, -35000)
wespescoutblue_1 = Artifact():setModel("WespeScoutBlue"):setCallSign("WespeScoutBlue"):setPosition(-42500, -37500)
wespescoutgreen_1 = Artifact():setModel("WespeScoutGreen"):setCallSign("WespeScoutGreen"):setPosition(-45000, -40000)

wespescoutgrey_1 = Artifact():setModel("WespeScoutGrey"):setCallSign("WespeScoutGrey"):setPosition(-7500, 0)
wespescoutwhite_1 = Artifact():setModel("WespeScoutWhite"):setCallSign("WespeScoutWhite"):setPosition(-10000, -2500)
ammo_box_1 = Artifact():setModel("ammo_box"):setCallSign("ammo_box"):setPosition(-12500, -5000)
battleship_destroyer_2_upgraded_1 = Artifact():setModel("battleship_destroyer_2_upgraded"):setCallSign("battleship_destroyer_2_upgraded"):setPosition(-15000, -7500)
shield_generator_1 = Artifact():setModel("shield_generator"):setCallSign("shield_generator"):setPosition(-17500, -10000)
small_frigate_1_1 = Artifact():setModel("small_frigate_1"):setCallSign("small_frigate_1"):setPosition(-20000, -12500)
small_frigate_2_1 = Artifact():setModel("small_frigate_2"):setCallSign("small_frigate_2"):setPosition(-22500, -15000)
space_frigate_6_1 = Artifact():setModel("space_frigate_6"):setCallSign("space_frigate_6"):setPosition(-25000, -17500)
